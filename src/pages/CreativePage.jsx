      ...
      <Link to={item.link}>
        <div className=" hover:bg-background p-3 shadow-sm h-full relative overflow-hidden group bg-background-50">
          <div className="flex flex-col">
            <div className=" group-hover:text-white text-link">
              {item.title}
            </div>
            <div className="text-sm text-background-900 group-hover:text-background-50">
              {item.description}
            </div>
          </div>
  ...
  return (
    <>
      <div className="p-5 px-8 grid grid-cols-1">
        <div className="text-sm text-secondary mb-2">Artistic Journey</div>
